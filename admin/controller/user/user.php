	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['users'][] = array(
				...
				'position'   => $this->model_user_user->getPositionById($result['position']),
				'department' => $this->model_user_user->getDepartmentById($result['department']),
		...
		$data['sort_position'] = $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'] . '&sort=position' . $url, true);
		...
		$data['sort_date_modified'] = $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'] . '&sort=date_modified' . $url, true);
		$url = '';
