...
class ControllerExtensionDashboardSale extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('staff/staff', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true));
		}
	...
	public function dashboard() {
		...
		$sale_total = $this->model_staff_staff->getTotalStaffs();
		...
		$data['sale'] = $this->url->link('staff/staff', 'user_token=' . $this->session->data['user_token'], true);
