...
class ControllerExtensionDashboardOnline extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('user/user', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true)
		);
		...
		$data['action'] = $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'], true);

		$data['cancel'] = $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true);
	...
	public function dashboard() {
		...
		// Customers Online
		$online_total = $this->model_user_user->getTotalUsers();
		...
		$data['online'] = $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'], true);
