<?php
class ControllerExtensionDashboardApplicant extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('applicant/applicant', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('applicant/applicant', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true)
		);
		...
		$data['cancel'] = $this->url->link('applicant/applicant', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true);
	...
	public function dashboard() {
		...
		$data['customer'] = $this->url->link('applicant/applicant', 'user_token=' . $this->session->data['user_token'], true);
