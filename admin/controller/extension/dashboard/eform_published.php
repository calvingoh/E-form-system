<?php
class ControllerExtensionDashboardEform_published extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('eform/eform', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('eform/eform', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true)
		);
		...
		$data['cancel'] = $this->url->link('eform/eform', 'user_token=' . $this->session->data['user_token'] . '&type=dashboard', true);
	...
	public function dashboard() {
		...
		$data['order'] = $this->url->link('eform/eform', 'user_token=' . $this->session->data['user_token'], true);
