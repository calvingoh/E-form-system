...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		// $this->document->addScript('view/javascript/formbuilder/dist/form-render.min.js');
		$this->document->addScript('view/javascript/formbuilder/dist/form-builder.min.js');
